...
use crate::{
    ...
    store::{
        metrics::{
            ...
            SNAPSHOT_CF_KV_COUNT, SNAPSHOT_CF_SIZE, SNAPSHOT_LIMIT_GENERATE_BYTES,
        },
...
pub struct SnapRecord {
    ...
    pub recv_duration_sec: u64,
    pub apply_start: Instant,
    pub apply_duration_sec: u64,
    pub finished: bool,
}
        ...
        match entry {
            ...
            SnapEntry::Sending => {
                if !finished {
                    ...
                    self.recv_duration_sec = Instant::now()
