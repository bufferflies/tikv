...
pub struct BatchTsoProvider<C: PdClient + ?Sized> {
    pd_client: Arc<C>,
...
impl<C: PdClient + ?Sized> std::fmt::Debug for BatchTsoProvider<C> {
...
impl<C: PdClient + ?Sized + 'static> BatchTsoProvider<C> {
...
#[async_trait]
impl<C: PdClient + ?Sized + 'static> CausalTsProvider for BatchTsoProvider<C> {
