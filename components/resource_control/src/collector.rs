...
impl ResourceCollector {
    pub fn new(dir: String) -> Self {
        ...
        let thread_prefixes = vec![
            (CpuType::RaftWorker, "raftstore_".to_string()),
            (CpuType::RaftIo, "raft_io".to_string()),
            (CpuType::Apply, "apply_".to_string()),
            (CpuType::StatusServer, "status_server".to_string()),
            (CpuType::PdWorker, "pd_worker_".to_string()),
            (CpuType::GrpcServer, "grpc_server_".to_string()),
            (CpuType::UnifiedReadPool, "unified_read_pool_".to_string()),
            (CpuType::RemoteCoprocessor, "remote_coproces".to_string()),
        ];
