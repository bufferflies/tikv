...
def KvEngine() -> RowPanel:
    layout = Layout(title="Kv Engine")
    layout.row(
        [
            graph_panel(
                title="Memory Usage",
        ...
        [
            graph_panel(
                ...
                targets=[
                    target(
                        expr=expr_sum_rate(
                            "kv_engine_get_duration_seconds_count",
                            by_labels=[],  # override default by instance.
                        ),
                        legend_format="get",
                        additional_groupby=True,
            ...
            graph_panel(
                ...
                targets=[
                    target(
                        expr=expr_histogram_quantile(
                            0.9999, "kv_engine_get_duration_seconds"
                        ),
                        legend_format="99.99%",
                        additional_groupby=True,
                    ),
        ...
        [
            graph_panel(
                ...
                targets=[
                    target(
                        expr=expr_sum_rate(
                            "kv_engine_seek_duration_seconds_count",
                            # override default by instance.
                            by_labels=["type"],
                        ),
                        additional_groupby=True,
                    ),
            ...
            graph_panel(
                ...
                targets=[
                    target(
                        expr=expr_histogram_quantile(
                            0.9999, "kv_engine_seek_duration_seconds"
                        ),
                        legend_format="99.99%",
                        additional_groupby=True,
                    ),
        ...
        [
            graph_panel(
                ...
                targets=[
                    target(
                        expr=expr_sum_rate(
                            "kv_engine_write_duration_seconds_count",
                            by_labels=[],  # override default by instance.
                        ),
                        legend_format="write",
                        additional_groupby=True,
            ...
            graph_panel(
                ...
                targets=[
                    target(
                        expr=expr_histogram_quantile(
                            0.9999, "kv_engine_write_duration_seconds"
                        ),
                        legend_format="99.99%",
                        additional_groupby=True,
                    ),
    ...
    layout.row(
        [
            graph_panel(
                title="Write flow",
                description="The bytes flow of write operations",
                yaxes=yaxes(left_format=UNITS.BYTES_SEC_IEC),
                targets=[
                    target(
                        expr=expr_sum_rate(
                            "kv_engine_write_flow_sum",
                            label_selectors=[
                                'type="bytes"',
                            ],
                            by_labels=[],  # override default by instance.
    ...
    layout.row(
        [
            ...
            graph_panel_histogram_quantiles(
                title="Keys / Write",
                description="The count of keys per write",
                yaxes=yaxes(left_format=UNITS.NO_FORMAT),
                metric="kv_engine_write_flow",
...
def RaftEngine() -> RowPanel:
    ...
    layout.row(
        [
            ...
            graph_panel(
                title="Read/Write Duration " + OPTIONAL_QUANTILE_INPUT,
                ...
                targets=[
                    target(
                        ...
                        legend_format="write-" + OPTIONAL_QUANTILE_INPUT,
                        additional_groupby=True,
                    ),
                    target(
                        expr=expr_histogram_quantile(
                        ...
                        legend_format="read-" + OPTIONAL_QUANTILE_INPUT,
                        additional_groupby=True,
                    ),
                ],
            ),
            ...
            graph_panel(
                ...
                targets=[
                    target(
                        ...
                        legend_format="backup-" + OPTIONAL_QUANTILE_INPUT,
                        additional_groupby=True,
                    ),
                ],
            ),
