...
impl DbConfig {
    pub fn build_opt(&self) -> RocksDbOptions {
        ...
        //     let limiter = RateLimiter::new_writeampbased_with_auto_tuned(
...
impl Default for CdcConfig {
    ...
    fn default() -> Self {
        Self {
            ...
            // TODO: currently, we use resolve_by_raft by default,
            // we may switch to check_leader if it's performance is better.
