...
fn test_stats_size() {
    ...
    let get_shard_size = |shard_id: u64| -> u64 {
    ...
    let expect_total_size = get_shard_size(client.get_region_id(&i_to_key(100)));
